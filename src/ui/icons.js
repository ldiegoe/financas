// Biblioteca de ícones SVG estilo Lucide (linha fina, currentColor).
// Centraliza pra manter consistência visual em vez de mistura de emojis +
// SVG inline. `icon(name, size)` retorna o SVG completo como string HTML.
...
export const ICONS = {
  ...
  chart: '<circle cx="12" cy="12" r="9"/><path d="M12 3a9 9 0 0 1 9 9h-9z"/>',
