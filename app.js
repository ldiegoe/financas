...
// sheetDespesa vive em src/ui/sheets/despesa.js — ligado no "wiring de sheets".
...
// sheetImportarBoletos vive em src/ui/sheets/importar-boletos.js
// — ligado no "wiring de sheets".
...
// sheetImportarOFX e MOTIVO_BADGE vivem em src/ui/sheets/importar-ofx.js
// — ligado no "wiring de sheets".
...
// palette, EMOJI_CHOICES e sheetCategoria vivem em src/ui/sheets/categoria.js
// — o sheet e ligado no "wiring de sheets".
...
// getState é getter porque `state` é `let` reatribuído (troca de perfil, pull
// do sync) — injetar o valor congelaria a referência.
const sheetCategoria = createSheetCategoria({
  openSheet, closeSheet, db, render, toast, getState: () => state,
});
// fmtBRL aqui é o wrapper que respeita "Ocultar valores" — não o helper puro.
...
const sheetImportarBoletos = createSheetImportarBoletos({
